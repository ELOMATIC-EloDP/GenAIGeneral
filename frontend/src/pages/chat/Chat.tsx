...
import Elomatic from "../../assets/Elomatic.png";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Elsa General ChatBot</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot can answer your general questions.</h2>
                            </Stack>
                        ) : (
